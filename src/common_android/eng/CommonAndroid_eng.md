...
Foreground Service Visible Process Service Process Background process Empty Process
...
#### Что такое PendingIntent? Если создаать два Pending Intent отличные только по данным помещенным в data, с какой ошибкой можно столкнуться?
